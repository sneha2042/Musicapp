...
const MusicPlayer = () => {
  ...
  useEffect(() => {
    console.log("allSongs in MusicPlayer useEffect:", song);
    if (song > allSongs.length) {
      dispatch({
        type: actionType.SET_SONG,
        song: 0,
      ...
      >
        ...
        <div className="flex-1">
          <AudioPlayer
            ...
            //src = "https://www.googleapis.com/drive/v3/files/1sS1yNtLbybxU8bn5XhGaW-CPGR9uMD__?alt=media&key=AIzaSyDGB0LJFat0Tj4SbKJLylPyP_Sn0VJcnJ4"
            onPlay={() => console.log("is playing",allSongs[song]?.songUrl) }
            autoPlay={true}
